  ...
  success: function (res) {
    ...
    $(".mywth").append(
      res.HeWeather6[0].basic.location +
        ' <img class="wea" src="https://cdn.heweather.com/img/plugin/190516/icon/c/' +
    ...
    $(".wea_hover").css(
      "background-image",
      "url(https://cdn.heweather.com/img/plugin/190516/bg/view/" +
        res.HeWeather6[0].now.cond_code +
        myday +
        ".png)"
    );
    ...
    $(".wea_top").append(
      '<span class="city"><b>' +
        ...
        ' 更新</span><span class="img" style="background:url(https://cdn.heweather.com/img/plugin/190516/icon/c/' +
        res.HeWeather6[0].now.cond_code +
        myday +
    ...
    //今日指数
    $(".wea_con ul").append(
      "<li>舒适度指数<br><b>" + res.HeWeather6[0].lifestyle[0].brf + "</b></li>"
    );
    $(".wea_con ul").append(
      "<li>穿衣指数<br><b>" + res.HeWeather6[0].lifestyle[1].brf + "</b></li>"
    );
    $(".wea_con ul").append(
      "<li>感冒指数<br><b>" + res.HeWeather6[0].lifestyle[2].brf + "</b></li>"
    );
    $(".wea_con ul").append(
      "<li>运动指数<br><b>" + res.HeWeather6[0].lifestyle[3].brf + "</b></li>"
    );
    $(".wea_con ul").append(
      "<li>旅游指数<br><b>" + res.HeWeather6[0].lifestyle[4].brf + "</b></li>"
    );
    $(".wea_con ul").append(
      "<li>紫外线指数<br><b>" + res.HeWeather6[0].lifestyle[5].brf + "</b></li>"
    );
    $(".wea_con ul").append(
      "<li>洗车指数<br><b>" + res.HeWeather6[0].lifestyle[6].brf + "</b></li>"
    );
    $(".wea_con ul").append(
      "<li>空气指数<br><b>" + res.HeWeather6[0].lifestyle[7].brf + "</b></li>"
    );
    ...
    $(".wea_foot ul").append(
      "<li>" +
        ...
        '<br><img src="https://cdn.heweather.com/img/plugin/190516/icon/c/' +
